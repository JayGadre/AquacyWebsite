...
|---|------|-------|-------------|--------|
| 5.1 | SEO & Meta | Fix missing meta tags, titles, descriptions, open graph tags. Ensure basic SEO tags are present across all pages. | none | DONE |
| 5.2 | Accessibility | Ensure standard semantic HTML, alt text on images, aria-labels where necessary. | none | IN_PROGRESS |
